...
const perguntas = [
  {
    ...
    alternativas: ["Criar máquinas que imitam o pensamento humano ", "Substituir completamente o trabalho humano"]
  },
  {
    enunciado: "Qual destas áreas é um campo da IA que permite aos computadores aprenderem a partir de dados sem serem explicitamente programados?",
    alternativas: ["Realidade Virtual", "Aprendizado de Máquina"]
  },
  {
    enunciado: "Qual é uma aplicação comum da IA no dia a dia?",
    alternativas: ["Máquinas de escrever antigas", "Assistentes de voz como a Siri ou Alexa"]
  }
];
